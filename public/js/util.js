...
function google_maps() {
    ...
    var autocompleteCurr = new google.maps.places.Autocomplete(curr_input);
    var autocompleteDest = new google.maps.places.Autocomplete(dest_input);
...
function placeMarker(location,map) {
    ...
    /*
     ...
     //var org=place_curr.geometry.location;
     //var dest=place_dest.geometry.location;
     var org = markers_currLoc[0].getPosition();
     var dest = markers_destLoc[0].getPosition();
